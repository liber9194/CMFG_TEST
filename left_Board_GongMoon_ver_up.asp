...
*/
	...
	{
		parent.frames[2].location = "right_main_gongmoon_ver_up.asp?type__=" + aa1 ;		
	}
	
	function write_Letter_CM(aa1)
	{
		parent.frames[2].location = "right_main_gongmoon_CM_ver_up.asp?type__=" + aa1 ;		
	}
	
	function Ilban_read(aa1)
	{
		parent.frames[2].location = "ilban_gongmoon_read_ver_up.asp?type__=" + aa1 ;		
	}

	function Ilban_write(aa1)
	{
		parent.frames[2].location = "ilban_gongmoon_write_ver_up.asp?type__=" + aa1 ;		
	}

	function Ilban_manager(aa1)
	{
		parent.frames[2].location = "ilban_gongmoon_manager_ver_up.asp?type__=" + aa1 ;		
	}

	function folder_manage(aa1)
	{
		parent.frames[2].location = "right_main_gongmoon_insert_ver_up.asp?type__=" + aa1;
	}
	
	function folder_manage_cm(aa1)
	{
		parent.frames[2].location = "right_main_gongmoon_insert_CM_ver_up.asp?type__=" + aa1;
	}
	
	function appr_sheet(aa1)
	{
		parent.frames[2].location = "gongmoon_appr_sheet_ver_up.asp?cond=" + aa1;
	}
	...
	function mail_export()
	{
		...
		parent.frames[2].location = "right_main_gongmoon_all_ver_up.asp";
	...
	{
		//parent.frames[2].location = "right_main_all.asp";
		parent.frames[2].location = "right_main_gongmoon_all_new1_ver_up.asp?type__=";
	...
	{
		//parent.frames[2].location = "right_main_all.asp";
		parent.frames[2].location = "right_main_gongmoon_all_new1_ver_up.asp?type__=1";
	...
	{
		//parent.frames[2].location = "right_main_all.asp";
		parent.frames[2].location = "right_main_gongmoon_all_new1_ver_up.asp?type__=2";
	...
	{
		//parent.frames[2].location = "right_main_all.asp";
		parent.frames[2].location = "right_main_gongmoon_all_new1_ver_up.asp?type__=&pOO=1";
	...
	{
		//parent.frames[2].location = "right_main_all.asp";
		parent.frames[2].location = "right_main_gongmoon_all_new1_ver_up.asp?type__=3";
...
function win2(aaa){
	...
	w = window.open("../Addr_New/select_manager_ver_up.asp", 'id_list', "scrollbars=auto,width=1000,height=803,left=0,top=0");		
...
<% if UCASE(db_level) = "S" THEN %>
		<div class="left_mail" title="공문함"></div>
		
		<h2>공문관리함</h2>
		<ul id="tree">		
			<li evt="0"><span onClick="mail_export1()" style="width:100%;letter-spacing:-0.8px;">공문관리함<br>&nbsp;&nbsp;&nbsp;&nbsp;(대표이사->발주청)</span></li>				
			<li evt="0"><span onClick="mail_export2()" style="width:100%;letter-spacing:-0.8px;">공문관리함<br>&nbsp;&nbsp;&nbsp;&nbsp;(건설사업관리단->CM부문)</span></li>				
			<li evt="0"><span onClick="mail_export3()" style="width:100%;letter-spacing:-0.8px;">공문관리함<br>&nbsp;&nbsp;&nbsp;&nbsp;(유관기관,기타)</span></li>				
			<li evt="0"><span onClick="mail_export4()" style="width:100%;letter-spacing:-0.8px;">공문관리함<br>&nbsp;&nbsp;&nbsp;&nbsp;(CM부문->건설사업관리단)</span></li>
			<li evt="0"><span onClick="mail_export5()" style="width:100%;letter-spacing:-0.8px;">공문관리함<br>&nbsp;&nbsp;&nbsp;&nbsp;(CM부문(대표이사)-><br>&nbsp;&nbsp;&nbsp;건설사업관리단,유관기관등)</span></li>
		</ul>
<% ELSEif UCASE(db_level) = "G" or UCASE(db_level) = "C" or UCASE(db_level) = "D" THEN  %>
		...
		<% if UCASE(db_level) = "Z" or UCASE(db_level) = "P" THEN %>
					<li evt="0"><span onClick="write_Letter('')" style="width:100%;letter-spacing:-0.8px;">공문접수함<br>&nbsp;&nbsp;&nbsp;&nbsp;(대표이사->발주청)</span></li>
					<li><span onClick="write_Letter('1')" style="width:100%;letter-spacing:-0.8px;">공문접수함<br>&nbsp;&nbsp;&nbsp;&nbsp;(건설사업관리단->CM부문)</span></li>
					<li><span onClick="write_Letter('2')" style="width:100%;letter-spacing:-0.8px;">공문접수함<br>&nbsp;&nbsp;&nbsp;&nbsp;(유관기관,기타)</span></li>			
			<% if site_code <> "25-0000-000" then %>			
			<% else %>			
			<% END IF %>
		<% else %>
				<% if site_code <> "" then %>
					<li evt="0"><span onClick="write_Letter('')" style="width:100%;letter-spacing:-0.8px;">공문접수함</span></li>	
				<% END IF %>
		<% END IF %>
		</ul>
...
<% ELSE %>
		...
		<% if UCASE(db_level) = "Z" or UCASE(db_level) = "P" THEN %>
			<% if db_id = "208097" THEN %>				
					<li><span onClick="write_Letter('1')" style="width:100%;letter-spacing:-0.8px;">공문접수함<br>&nbsp;&nbsp;&nbsp;&nbsp;(건설사업관리단->CM부문)</span></li>
					<li><span onClick="write_Letter('2')" style="width:100%;letter-spacing:-0.8px;">공문접수함<br>&nbsp;&nbsp;&nbsp;&nbsp;(대외,FAX,기타)</span></li>
					<li><span onClick="write_Letter_CM('3')" style="width:100%;letter-spacing:-0.8px;">공문접수함<br>&nbsp;&nbsp;&nbsp;&nbsp;(CM부문(대표이사)-><br>&nbsp;&nbsp;&nbsp;건설사업관리단,유관기관등)</span></li>
			<% else %>
					<li evt="0"><span onClick="write_Letter('')" style="width:100%;letter-spacing:-0.8px;">공문접수함<br>&nbsp;&nbsp;&nbsp;&nbsp;(대표이사->발주청)</span></li>
					<li><span onClick="write_Letter('1')" style="width:100%;letter-spacing:-0.8px;">공문접수함<br>&nbsp;&nbsp;&nbsp;&nbsp;(건설사업관리단->CM부문)</span></li>
					<li><span onClick="write_Letter('2')" style="width:100%;letter-spacing:-0.8px;">공문접수함<br>&nbsp;&nbsp;&nbsp;&nbsp;(유관기관,기타)</span></li>
		...
		<% else %>
				...
				<% if site_code <> "" then %>
					<li evt="0"><span onClick="write_Letter('')" style="width:100%;letter-spacing:-0.8px;">공문접수함</span></li>
					<li evt="0"><span onClick="write_Letter_CM('3')" style="width:100%;letter-spacing:-0.8px;">공문접수함<br>&nbsp;&nbsp;&nbsp;&nbsp;(CM부문(대표이사)-><br>&nbsp;&nbsp;&nbsp;건설사업관리단,유관기관등)</span></li>
		...
		<% if UCASE(db_level) = "Z" or UCASE(db_level) = "P" THEN %>
			<% if db_id = "208097" THEN %>	
            	    <li evt="0"><span onClick="write_Letter('')" style="width:100%;letter-spacing:-0.8px;">공문발송함<br>&nbsp;&nbsp;&nbsp;&nbsp;(대표이사->발주청)</span></li>
					<li evt="0"><span onClick="folder_manage('')" style="width:100%;letter-spacing:-0.8px;">공문발송함</span></li>
					<li evt="0"><span onClick="folder_manage_cm('3')" style="width:100%;letter-spacing:-0.8px;">공문발송함<br>&nbsp;&nbsp;&nbsp;&nbsp;(CM부문(대표이사)-><br>&nbsp;&nbsp;&nbsp;건설사업관리단,유관기관등)</span></li>
			<% ELSE %>
					<li evt="0"><span onClick="folder_manage('')" style="width:100%;letter-spacing:-0.8px;">공문발송함</span></li>
		...
		<% else %>
				<% if site_code <> "" then %>
					<li evt="0"><span onClick="folder_manage('')" style="width:100%;letter-spacing:-0.8px;">공문발송함<br>&nbsp;&nbsp;&nbsp;&nbsp;(대표이사->발주청)</span></li>
							<li><span onClick="folder_manage('1')" style="width:100%;letter-spacing:-0.8px;">공문발송함<br>&nbsp;&nbsp;&nbsp;&nbsp;(건설사업관리단->CM부문)</span></li>
				<% END IF %>
		<% END IF %>
				...
				<ul id="tree">
					<% if UCASE(db_level) = "Z" or UCASE(db_level) = "P"  THEN %>
						<li evt="0"><span onClick="win2('<%=db_level%>')" style="width:100%;letter-spacing:-0.8px;">주소록</span></li>	
					<% else %>
						<% if site_code <> "" then %>
...
<% END IF %>
	...
	<% if UCASE(db_level) = "S" THEN %>
				...
				<h2>요청자료</h2>
				<ul id="tree">
					<li evt="0"><span onClick="Ilban_write('')" style="width:100%;letter-spacing:-0.8px;">요청자료발송함</span></li>	
					<li><span onClick="Ilban_manager()" style="width:100%;letter-spacing:-0.8px;">요청자료관리함</span></li>				
				</ul>  
	...
	<% ELSEif UCASE(db_level) = "G" or UCASE(db_level) = "C" or UCASE(db_level) = "D" THEN  %>
				...
				<h2>요청자료</h2>
				<ul>
					<li evt="0"><span onClick="Ilban_read('')" style="width:100%;letter-spacing:-0.8px;">요청자료접수함</span></li>	
			...
			<% if UCASE(db_level) = "Z" or UCASE(db_level) = "P" THEN %>
				...
				<ul>
					...
					<% if UCASE(db_level) = "Z" THEN %>				
								<li><span onClick="Ilban_manager()" style="width:100%;letter-spacing:-0.8px;">요청자료관리함</span></li>				
					<% else %>
								<li><span onClick="Ilban_read('')" style="width:100%;letter-spacing:-0.8px;">요청자료접수함</span></li>	
					<% END IF %>
				</ul>
	...
	<% if db_id = "216050" or db_id = "208097" or db_id = "206171" or db_id = "205021" then %>
		...
		<ul>			
			<% if UCASE(db_level) = "Z" or UCASE(db_level) = "S" THEN %>				
				<li><span onClick="appr_sheet('all')" style="width:100%;letter-spacing:-0.8px;">PM 결재현황</span></li>				
			<% elseif UCASE(db_level) = "P" then %>
				<li><span onClick="appr_sheet('mine')" style="width:100%;letter-spacing:-0.8px;">공문결재현황</span></li>	
			<% END IF %>
		</ul>
	<% end if %>

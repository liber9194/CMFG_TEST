...
function WebPartToggle(obj)
{
	...
	function D_fUN_1(Pcode,Pstr)
	{
		...
		parent.frames[2].location = "right_JaRyo_Re.asp?code=" + Pcode + "&Qstr=" + Pstr;
	}
...
<div id="left">
		<div class="left_apprg" title="전자결재"></div>

		<h2>공지 게시판</h2>
		<ul>		     
					<li><span style="width:100%" onClick="D_fUN(101,'공지사항')">공지사항</span></li>						  
					<li><span style="width:100%" onClick="D_fUN(102,'경사')">경사</span></li>						  
					<li><span style="width:100%" onClick="D_fUN(103,'조사')">조사</span></li>						 
		</ul> 			


		<h2>CM단 게시판</h2>
		<ul>		     
					<li><span style="width:100%" onClick="D_fUN(121,'CM단 게시판')">CM단 게시판</span></li>						 
		</ul> 		


		<h2>업무 질의 응답</h2>
		<ul>		     
					<li><span style="width:100%" onClick="D_fUN_1(141,'업무 질의 응답')">업무 질의 응답</span></li>						 
		</ul> 		

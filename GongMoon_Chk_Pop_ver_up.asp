...
function read_gongMoon(o_seq, o_receive_id, o_send_longname, o_visited, private__, type__) {
	...
	if (type__ == "3")
	{
		url = "../ezEmail/mail_read_CM_ver_up.asp?Seq=" + o_seq + "&rID=" + o_receive_id + "&stype=접수&HJname=" + o_send_longname + "&visited=" + o_visited + "&PP=" + private__;
	}
	else
	{
...
<body class="popup"> 
	<h1 style="margin-bottom:5px;"> 공문 리스트 </h1>
	<div id="close">
		<ul>
	...
	<% else %>
		...
		<div class="box" style="height:600">
			<table width="100%" class="popuplist">
				...
				<th style="text-align:center;">발신현장명</th>
				<th style="text-align:center;">보낸날</th>
				<th style="text-align:center;">조회여부</th>

...
<% if UCASE(db_level) = "Z" or UCASE(db_level) = "P" THEN %>
			<li evt="0"><span onClick="write_Letter('')" style="width:100%">공문접수함(대표이사->발주청)</span></li>
			<li><span onClick="write_Letter('1')" style="width:100%">공문접수함(책임감리원->감리본부)</span></li>
			<li><span onClick="write_Letter('2')" style="width:100%">공문접수함(유관기관,기타)</span></li>
<% else %>
...
<% else %>
		<% if site_code <> "" then %>
			<li evt="0"><span onClick="folder_manage('')" style="width:100%">공문발송함(대표이사->발주청)</span></li>
					<li><span onClick="folder_manage('1')" style="width:100%">공문발송함(책임감리원->감리본부)</span></li>
		<% END IF %>
<% END IF %>
